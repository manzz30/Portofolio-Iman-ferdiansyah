      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              <img src="public/assets/profile.png" className="w-10 rounded-md" alt="Iman Ferdiansyah" />
              <q>Avoid or just undertake it</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Iman Ferdiansyah" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text="Mahasiswa IT yang antusias mengembangkan solusi digital melalui pemrograman dan analisis sistem."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
          ...
          <div className="md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard
              name="Iman Ferdiansyah"
              title="Web Developer"
              handle="imanferdiansyah"
              status="Online"
              contactText="Contact Me"
              avatarUrl="public/assets/profile.png"
              showUserInfo={true}
              enableTilt={true}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
              ...
              <div className="flex-1 text-left">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  ...
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      3.78<span className="text-violet-500">/4.00</span>
                    </h1>
                    <p>GPA</p>
                  </div>
                </div>
            ...
            <div className="basis-full md:basis-5/12 pl-0 md:pl-8 overflow-hidden max-w-full flex justify-center ">
              <img 
                ...
                alt="Iman Ferdiansyah"
                className="w-64 h-64 md:w-72 md:h-72 object-cover rounded-2xl border-2 border-violet-500/40 shadow-xl"
              />
            </div>
          </div>
        </div>
        ...
        <div className="proyek-box mt-14">
          <div style={{ height: 'auto', position: 'relative' }} data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" data-aos-once="true">
            ...
            <form
                action="https://formsubmit.co/imanferdiansyah001@gmail.com"
                method="POST"
